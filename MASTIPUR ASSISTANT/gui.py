...
def ask():
    ...
    if bot_val == "ok sir":
        root.destroy()
        # destruction of the root directory and ncould start it agai
...
# we could true that too based on the resizable factor and the different culumtive effect...
...
# Text Lable 
Text_lable = Label(Main_frame, text = "MASTIPUR ASSISTANT" , font=("comic Sans ms" ,  14 , "bold" ) , bg = "#356696")
Text_lable.grid(row=0 ,  column=0 , padx=20 , pady= 10)


# Image 
Display_Image = ImageTk.PhotoImage(Image.open("image/mastipur.jpg").resize((200, 200)))
